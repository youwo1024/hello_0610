...
| 类别 | 配置 |
| :------------: | :------------: |
| 出国版 | [Outbound](https://gcore.jsdelivr.net/gh/youwo1024/hello@rules/Quantumult/Outbound.conf) |
| 回国版 | [Inbound](https://gcore.jsdelivr.net/gh/youwo1024/hello@rules/Quantumult/Inbound.conf) |
...
建议在「其他设置」里「GeoLite2」的「来源」填写使用「 https://gcore.jsdelivr.net/gh/Loyalsoldier/geoip/release/Country.mmdb 」并开启「自动更新」
